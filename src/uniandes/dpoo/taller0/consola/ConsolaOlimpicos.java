...
public class ConsolaOlimpicos
{
	...
	/**
	 * Le muestra el usuario el pa�s al que pertenece un atleta dado
	 */
	private void ejecutarPaisAtleta()
	{
		...
		Pais pais = calculadora.paisAtleta(atleta);
			if (pais != null)
				{
				System.out.println("El atleta ingresado es del pa�s" + "\n"+ pais);
				}
			else
				{
				System.out.println("El atleta ingresado no se encuentra en nuestra base de datos.");
				}
